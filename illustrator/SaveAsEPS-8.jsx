...
as EPS version 8 with the same file name in the user
...
sourceFolder = Folder.selectDialog('Select the folder with EPS files you want to re-save to EPS v 8', '~');
...
function getEPSOptions() {
	...
	epsSaveOpts.compatibility = Compatibility.ILLUSTRATOR8; // == 8
